...
<h2>Мнения <a title="RSS лента раздела Политика" href="#"><span class="label label-warning">RSS</span></a></h2>
<hr />
...
<?php foreach ($dataProvider as $item): ?>
    ...
    <div class="row-fluid news-container">
        ...
        <div class="span9">
            <h4><?php echo CHtml::link($item['title'] . '<br />', Yii::app()->createUrl(Article::model()->getCategoryAlias($blog['cat_id']) . '/' . $blog['id']) ); ?></h4>
