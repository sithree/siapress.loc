...
<!-- 3 -->
<div id="rontar_adplace_3851"></div>
<div style="margin-bottom: 15px;"></div>
<script type="text/javascript"><!--
    (function(w, d, n) {
        var ri = {rontar_site_id: 1717, rontar_adplace_id: 3851, rontar_place_id: 'rontar_adplace_3851', adCode_rootUrl: 'http://adcode.rontar.com/'};
        w[n] = w[n] || [];
        w[n].push(
                ri
                );
