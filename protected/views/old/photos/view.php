...
?>
<?php echo mb_strlen($model['introtext'], 'utf-8') > 10 ? CHtml::tag('h3', array('class' => 'introtext'), $model['introtext']) : ''; ?>
<hr />
...
<?php if ($photos): ?>
    <div id="ph" class="row-fluid">
        ...
        foreach ($photos[1] as $key => $photo):
            ?>
            <div class="exclusive">
                <a rel="gallery" href="<?php echo $photos[0][$key]; ?>" style="display: block; background: #ccc; width: 100%; height: 100%;" classs="ex_link">
...
<hr />
<b><?php echo Helper::getFormattedtime($model['publish']) ?></b>, просмотров: <?php echo ($model['hits']) ? $model['hits'] : 'не известно'; ?>, комментариев: <?php echo $model['comment_count'] ?>
<hr />
