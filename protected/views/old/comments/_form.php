        ...
        <div class="span12">
            ...
            <?php if (Yii::app()->user->isGuest): ?>
                ...
                <div class="row-fluid" style="margin-bottom: 10px;">
                    <div class="span6">
                        <?php echo $form->textFieldRow($commentform, 'username', array('class' => 'span12')); ?>
            ...
            <div class="row-fluid" style="margin-bottom: 10px;">
                <?php if (Yii::app()->user->isGuest): ?>
                    ...
                    <div class="span12">
                        <?php echo $form->textAreaRow($commentform, 'text', array('class' => 'span12', 'rows' => 5)); ?>
            ...
            <div class="row-fluid">
                <div class="span4">
                    <?php if (Yii::app()->user->isGuest): ?>
                        <?php echo $form->textFieldRow($commentform, 'capcha', array('class' => 'span12')); ?>
