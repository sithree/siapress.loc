<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('author_alias')); ?>:</b>
	<?php echo CHtml::encode($data->author_alias); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('modif_by')); ?>:</b>
	<?php echo CHtml::encode($data->modif_by); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('comment_on')); ?>:</b>
	<?php echo CHtml::encode($data->comment_on); ?>
	<br />
