                ...
                <div class="row">
                    <div class="span3" style="position: relative;"><!-- Лого и погода -->
                        <div class="logo">
                            ...
                            <div style="width:822px;  z-index:-1; position: absolute; left: 218px; top: 0px;"><img src="/images/ny2013.gif" /></div>
                            <div style="position: absolute; left: 185px; top: 0px; color: #ca0000; font-size: 14px; font-weight:bold;background: #ca0000;color: white;padding: 1px 4px;border-radius: 3px; -moz-border-radius: 3px; -webkit-border-radius: 3px;z-index: 999;">12+</div>
                        </div>
                    </div><!-- // Лого и погода -->
...
//                    'active' => @Yii::app()->controller->actionParams['category'] == 'noise'),
                                        ...
                                        array('label' => 'Операция: "Подъезд!"', 'url' => array('site/rupot')),
                                    /*
                                      array('label' => 'Новости', 'items' => array(
