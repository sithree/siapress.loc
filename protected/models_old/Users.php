...
class Users extends CActiveRecord {
    ...
    public function scopes() {
        return array(
            'author' => array(
                'order' => '`name`',
                'condition' => 'perm_id = 1 or perm_id = 2',
    ...
    public function rules() {
        ...
        return array(
            array('name, last_visit, register_date', 'required'),
            array('active, vk_id, fb_id, login_from, perm_id', 'numerical', 'integerOnly' => true),
