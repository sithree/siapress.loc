...
/**
 * This is the model class for table "{{article_migrate}}".
 *
 * The followings are the available columns in table '{{article_migrate}}':
 * @property integer $id_old
 * @property integer $id_new
 */
class ArticleMigrate extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ArticleMigrate the static model class
	 */
