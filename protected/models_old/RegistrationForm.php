...
class RegistrationForm extends CFormModel {
    ...
    public function rules() {
        return array(
            ...
            array('email', 'required', 'message' =>'Необходимо ввести почтовый ящик'),
    ...
    public function testlogin($attribute, $params) {
        $l = User::model()->find('username = "' . $this->login . '"');
        if ($l) {
